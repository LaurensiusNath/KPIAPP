...
class Edit extends Component
{
    ...
    public function mount(DivisionModel $division, DivisionService $divisionService): void
    {
        $this->divisionData = $divisionService->findDivisionById($division->id);
    }
    ...
    public function changeLeader(DivisionService $divisionService): void
    {
        ...
        $this->divisionData = $divisionService->findDivisionById($this->divisionData->id);
    ...
    {
        return view('livewire.admin.divisions.edit');
    }
}

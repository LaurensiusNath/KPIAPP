<div class="antialiased bg-gray-50 dark:bg-gray-900">
    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        <aside id="drawer-navigation" aria-label="Sidenav"
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ $is('admin.dashboard') }}">
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}"
                            ...
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M17 20h5v-2a4 4 0 00-3-3.85M9 20h6m-6 0a4 4 0 01-4-4v-1a4 4 0 014-4h6a4 4 0 014 4v1a4 4 0 01-4 4m-6 0h6M16 7a4 4 0 10-8 0 4 4 0 008 0z" />
                            </svg>
                            Users
                        </a>
                    </li>
                    ...
                    <li class="pt-2 mt-2 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" wire:click="logout"
                            class="flex items-center gap-3 p-2 w-full rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 text-left">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"

<div class="p-1">
    <form wire:submit.prevent="createDivision" class="space-y-4">
        <div>
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Division
                Name</label>
        ...
        <div>
            <label for="leader" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Team
                Leader</label>
            <select id="leader" wire:model.live="leaderId"

<section class="bg-gray-50 dark:bg-gray-900 p-3 sm:p-5 min-h-screen max-h-screen overflow-y-auto">
        ...
        <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
            <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                ...
                <div
                    ...
                    <button type="button" wire:click="openCreateDivisionModal"
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @forelse ($this->divisions as $division)
                            <livewire:admin.divisions.row :division="$division" :key="'division-row-' . $division->id" />
                        @empty
                            <tr class="border-b dark:border-gray-700">
                                <td colspan="4"
                                    class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                    No divisions found.</td>
                            </tr>
                        @endforelse
    ...
    {{-- Create Division Modal (Livewire-controlled) --}}
    @if ($showCreateDivisionModal)
        <div
            ...
            <div class="relative p-4 w-full max-w-xl max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                    <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Create Division</h3>
                        <button type="button" wire:click="closeCreateDivisionModal"
                    ...
                    <div class="p-4 md:p-5">
                        <livewire:admin.divisions-create />
                    </div>
                </div>
            </div>
        </div>

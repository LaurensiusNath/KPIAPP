    ...
    <nav
        ...
        <div class="flex flex-wrap justify-between items-center">
            <div class="flex justify-start items-center">
                ...
                <a href="{{ route('tl.dashboard') }}" class="flex items-center justify-between mr-4">
                    <img src="{{ asset('assets/logo.png') }}" class="mr-3 h-8" alt="BNPKPI Logo" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BNPKPI</span>
                </a>
            ...
            <div class="flex items-center lg:order-2">
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
                    ...
                    <ul class="py-1 text-gray-700 dark:text-gray-300" aria-labelledby="dropdown">
                        <li>
                            <button type="button" wire:click="logout"
                                class="block py-2 px-4 text-sm hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-400 dark:hover:text-white w-full text-left">
                                Sign out
                            </button>
                        </li>
                    </ul>
    ...
    <div class="antialiased bg-gray-50 dark:bg-gray-900">
        <aside
            ...
            <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('tl.dashboard') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.dashboard') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">

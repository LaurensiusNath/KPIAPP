<div class="antialiased bg-gray-50 dark:bg-gray-900">
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('tl.members') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.members', 'tl.kpi.items', 'tl.kpi.plan', 'tl.kpi.monthly', 'tl.kpi.history') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                    ...
                    <li>
                        <a href="{{ route('tl.division.analytics') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.division.analytics') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M11 3.055A9.001 9.001 0 1020.945 13H11V3.055z" />
                                <path stroke-linecap="round" stroke-linejoin="round" d="M20.488 9H15V3.512" />
                            </svg>
                            <span>Analitik Divisi</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('tl.kpi.members') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.kpi.members') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    @php($currentUser = request()->route('user'))
                    @if ($currentUser)
                        <li>
                            <a href="{{ route('tl.kpi.plan', $currentUser) }}"
                                class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.kpi.plan') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M8 7V3m8 4V3M3 11h18M5 21h14a2 2 0 002-2V7H3v12a2 2 0 002 2z" />
                        ...
                        <li>
                            <a href="{{ route('tl.appraisal.form', $currentUser) }}"
                                class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('tl.appraisal.form') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                    viewBox="0 0 24 24">
                    ...
                    <li class="pt-2 mt-2 border-t border-gray-200 dark:border-gray-700">
                        <button type="button" wire:click="logout"
                            class="flex items-center gap-3 p-2 w-full rounded-lg text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round"
    ...
    {{-- Main content slot removed; include <main> in layout instead --}}
</div>

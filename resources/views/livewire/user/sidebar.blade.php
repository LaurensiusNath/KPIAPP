                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('user.dashboard') }}"
                            class="flex items-center gap-3 p-2 rounded-lg text-sm font-medium {{ request()->routeIs('user.dashboard') ? 'bg-primary-50 text-primary-700 dark:bg-gray-700 dark:text-white' : 'text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700' }}">
